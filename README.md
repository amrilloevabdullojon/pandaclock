...
| Документ | Что внутри |
|----------|-----------|
| [AGENTS.md](AGENTS.md) | **Главный файл для AI-агентов.** Правила, стек, workflow |
| [CLAUDE.md](CLAUDE.md) | Дополнения специфично для Claude Code |
| [docs/Техническое_задание.md](docs/Техническое_задание.md) | ЧТО строим |
| [docs/Архитектура_и_стек.md](docs/Архитектура_и_стек.md) | КАК строим |
...
См. [AGENTS.md](AGENTS.md) для полного списка.
...
Разрабатывается AI-агентами (Claude Code, OpenAI Codex) под руководством [имя владельца].

Для участия — см. [AGENTS.md](AGENTS.md).
